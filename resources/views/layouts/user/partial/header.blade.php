                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav ">
                    ...
                    <li class="nav-item active">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="category_product.html">Gents Dress</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="category_product.html">Kids</a>
                      </li>
                      <li class="nav-item active">
                        <a class="nav-link" href="category_product.html">Women Dress <span class="sr-only">(current)</span></a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="category_product.html">Mosaic</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="category_product.html">Sugar Dishes</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="category_product.html">Coffee Dishes</a>
                      </li>
                      <li class="nav-item">
